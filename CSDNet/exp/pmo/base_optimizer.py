...
def _dump_yaml_atomic(data, output_file_path):
    """Write a PMO checkpoint without exposing a partially written YAML file."""
...
class Oracle:
    ...
    def save_result(self, suffix=None):
        ...
        self.sort_buffer()
        _dump_yaml_atomic(self.mol_buffer, output_file_path)
