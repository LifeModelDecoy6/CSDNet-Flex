...
class SMILESTokenizer:
    ...
    def aromatic_context_mask(self, smi, max_len):
        """Return a token-position mask for aromatic atoms and aromatic ring context.

        This is deliberately token-aligned rather than RDKit-aligned: lowercase
        SMILES atoms are the authoritative aromatic annotations in the training
        sequence, and ring/bond context is inferred from the same token stream.
        """
